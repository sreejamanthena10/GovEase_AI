  ...
  return (
    <main className="min-h-screen bg-radial-hero text-foreground">
      ...
      <Sheet open={overlayOpen} onOpenChange={setOverlayOpen}>
        <SheetContent
          side="right"
          className="h-full w-full max-w-3xl overflow-y-auto border-l border-border glass p-0 shadow-2xl"
          aria-describedby="analysis-description"
        >
          <SheetHeader className="sr-only">
            <SheetTitle>Document analysis</SheetTitle>
            <SheetDescription id="analysis-description">
              Simplified FormSync results for your uploaded government document.
            </SheetDescription>
          </SheetHeader>
          <AnalysisPanel
            stage={stage}
